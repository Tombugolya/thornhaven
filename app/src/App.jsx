  ...
  if (loading || checkingAuth) {
    return (
      <div className="fixed inset-0 bg-bg-deep flex items-center justify-center overflow-hidden">
        ...
        <div className="relative flex flex-col items-center gap-8" style={{ animation: "loadFadeIn 0.6s ease-out" }}>
          {/* Rune circle */}
          <div className="relative w-28 h-28">
            {/* Outer ring */}
            <svg className="absolute inset-0 w-full h-full" viewBox="0 0 100 100" style={{ animation: "runeRotate 12s linear infinite" }}>
              <circle cx="50" cy="50" r="46" fill="none" stroke="#c9a227" strokeWidth="0.5" opacity="0.3" />
              <circle cx="50" cy="50" r="46" fill="none" stroke="#c9a227" strokeWidth="1" opacity="0.6"
            ...
            {/* Inner ring */}
            <svg className="absolute inset-0 w-full h-full" viewBox="0 0 100 100" style={{ animation: "runeRotateReverse 8s linear infinite" }}>
              <circle cx="50" cy="50" r="32" fill="none" stroke="#c9a227" strokeWidth="0.5" opacity="0.2" />
              <circle cx="50" cy="50" r="32" fill="none" stroke="#c9a227" strokeWidth="0.8" opacity="0.5"
                strokeDasharray="4 8 6 10" />
            </svg>

            {/* Center compass / d20 shape */}
            <svg className="absolute inset-0 w-full h-full" viewBox="0 0 100 100" style={{ animation: "runePulse 3s ease-in-out infinite" }}>
              {/* Inner triangle pattern (d20 face) */}
          ...
          <div className="text-center space-y-2">
            ...
            <div className="flex items-center justify-center gap-1.5">
              {["Consulting", "the", "ancient", "tomes"].map((word, i) => (
                <span
                  key={i}
