export default function Particles({ type, accentColor }) {
  const configs = {
    ...
    bioluminescence: { count: 35, sizeRange: [2, 5], speed: [6, 14], opacity: 0.5, color: "#1abc9c" },
        ...
        return (
          <div
            ...
            style={{
              ...
              filter: type === "bioluminescence" || type === "void"
                ? `blur(${size > 3 ? 2 : 0}px)`
                : type === "fog"
                ? `blur(${size / 3}px)`
                : "none",
              boxShadow: type === "bioluminescence"
