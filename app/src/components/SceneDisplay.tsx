...
const symbolSvgs: Record<string, (color: string) => React.ReactNode> = {
  shield: (color) => (
    <svg viewBox="0 0 120 140" className="w-full h-full">
      ...
      <path
        d="M60,8 L110,30 L105,90 L60,130 L15,90 L10,30 Z"
        fill="none"
  ...
  quill: (color) => (
    <svg viewBox="0 0 120 140" className="w-full h-full">
      <path
        d="M85,10 Q70,50 50,90 L45,130 L50,125 Q65,85 95,15 Z"
        fill={color}
        fillOpacity="0.1"
        stroke={color}
        strokeOpacity="0.5"
  ...
  flask: (color) => (
    <svg viewBox="0 0 120 140" className="w-full h-full">
      <path
        d="M48,10 L48,50 L20,110 Q18,125 35,128 L85,128 Q102,125 100,110 L72,50 L72,10 Z"
        fill={color}
        fillOpacity="0.06"
        stroke={color}
        strokeOpacity="0.5"
      ...
      />
      <path
        d="M28,95 Q60,85 92,95 L100,110 Q102,125 85,128 L35,128 Q18,125 20,110 Z"
        fill={color}
        fillOpacity="0.12"
      />
  ...
  mug: (color) => (
    <svg viewBox="0 0 120 140" className="w-full h-full">
      ...
      />
      <path
        d="M85,55 Q105,55 105,75 Q105,95 85,95"
        fill="none"
        stroke={color}
        strokeOpacity="0.4"
        strokeWidth="2"
      />
      <path
        d="M35,38 Q40,20 50,30 Q55,15 65,28 Q72,18 78,38"
        fill="none"
        stroke={color}
        strokeOpacity="0.2"
        strokeWidth="1.5"
  ...
  fish: (color) => (
    <svg viewBox="0 0 140 100" className="w-full h-full">
      <path
        d="M30,50 Q60,15 100,50 Q60,85 30,50 Z"
        fill={color}
        fillOpacity="0.08"
        stroke={color}
        strokeOpacity="0.5"
  ...
  spear: (color) => (
    <svg viewBox="0 0 60 140" className="w-full h-full">
      ...
      <path
        d="M30,5 L40,30 L30,25 L20,30 Z"
        fill={color}
        fillOpacity="0.3"
        stroke={color}
        strokeOpacity="0.6"
  ...
  wave: (color) => (
    <svg viewBox="0 0 140 100" className="w-full h-full">
      <path
        d="M10,50 Q35,20 60,50 Q85,80 110,50 Q120,35 130,50"
        fill="none"
        stroke={color}
        strokeOpacity="0.5"
        strokeWidth="2.5"
      ...
      />
      <path
        d="M10,70 Q35,40 60,70 Q85,100 110,70"
        fill="none"
        stroke={color}
        strokeOpacity="0.25"
        strokeWidth="2"
  ...
  spiral: (color) => (
    <svg viewBox="0 0 120 120" className="w-full h-full">
      <path
        d="M60,60 m0,-40 a40,40 0 1,1 0,80 a30,30 0 1,0 0,-60 a20,20 0 1,1 0,40 a10,10 0 1,0 0,-20"
        fill="none"
        stroke={color}
        strokeOpacity="0.5"
        strokeWidth="2"
...
function LocationScene({ scene }: { scene: SceneData }) {
  ...
  return (
    <>
      <Particles type={scene.particles || "dust"} accentColor={scene.accentColor} />
      ...
      {/* Content */}
      <div
        className={`relative z-10 flex flex-col items-center justify-center h-full text-center px-8 transition-all duration-1000 ${
          entered ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
        }`}
      >
        <p
          className="text-sm tracking-[0.4em] uppercase mb-3 font-light"
          style={{ color: scene.accentColor, opacity: 0.7 }}
        >
          {scene.subtitle}
        </p>
        <h1
          className="font-[family-name:var(--font-display)] text-5xl md:text-7xl lg:text-8xl font-bold tracking-wider mb-6"
          style={{
        ...
        />
        <p
          className={`text-parchment/50 text-lg md:text-xl max-w-xl leading-relaxed italic transition-all duration-1000 delay-500 ${
...
function CharacterScene({ scene }: { scene: SceneData }) {
  const [entered, setEntered] = useState(false)
  useEffect(() => {
    const t = setTimeout(() => setEntered(true), 100)
    return () => clearTimeout(t)
  ...
  const SymbolComponent = scene.symbol ? symbolSvgs[scene.symbol] : undefined
  ...
  return (
    <>
      ...
      >
        ...
        {SymbolComponent && (
          <div
            className={`w-24 h-28 md:w-32 md:h-36 mb-8 transition-all duration-1200 delay-200 ${
              entered ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
        ...
        <h1
          className="font-[family-name:var(--font-display)] text-4xl md:text-6xl lg:text-7xl font-bold tracking-wider mb-3"
          style={{
            color: scene.accentColor,
        ...
        <p
          className="text-sm tracking-[0.4em] uppercase mb-6 font-light"
        ...
        />
        <p
          className={`text-parchment/50 text-lg md:text-xl max-w-lg leading-relaxed italic transition-all duration-1000 delay-500 ${
            entered ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"
          }`}
        >
          {scene.description}
...
function CombatScene({ scene }: { scene: SceneData }) {
  const [entered, setEntered] = useState(false)
  useEffect(() => {
    const t = setTimeout(() => setEntered(true), 100)
    return () => clearTimeout(t)
  ...
  return (
    <>
      ...
      {/* Content */}
      <div
        className={`relative z-10 flex flex-col items-center justify-center h-full text-center px-8 transition-all duration-700 ${
          entered ? "opacity-100 scale-100" : "opacity-0 scale-105"
        }`}
      >
        {/* Crossed swords icon */}
        <div
          className={`mb-6 transition-all duration-800 delay-100 ${
            entered ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          }`}
        >
        ...
        <p
          className="text-xs tracking-[0.5em] uppercase mb-2 font-semibold"
        ...
        />
        <p
          className={`text-parchment/50 text-lg max-w-lg leading-relaxed italic transition-all duration-1000 delay-400 ${
...
export default function SceneDisplay({ scene }: { scene: SceneData }) {
