...
function SessionCard({ roomCode, session, onSelect, onDelete }) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        <div className="font-mono text-lg font-bold text-gold tracking-widest">
          {roomCode}
        </div>
...
export default function SessionPicker({ campaignId, dmUid, onSelectSession, onBack }) {
