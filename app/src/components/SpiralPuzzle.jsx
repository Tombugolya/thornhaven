...
const RUNE_PATHS = {
  ...
  skull:     "M-8,-2 c0,-6 4,-10 8,-10 c4,0 8,4 8,10 c0,4 -2,7 -4,8 l-1,4 h-6 l-1,-4 c-2,-1 -4,-4 -4,-8z M-3,-4 a2,2 0 1,0 .1,0z M4,-4 a2,2 0 1,0 .1,0z",
...
function runePosition(ringIndex, posIndex) {
...
export default function SpiralPuzzle({ handout }) {
  ...
  return (
    <div
      ...
      style={{ background: "radial-gradient(ellipse at 50% 60%, #0e1318 0%, #080c10 50%, #050608 100%)" }}
    >
      ...
      >
        ...
        {/* Solve pulse rings */}
        {solvePhase >= 1 && RINGS.map((ring, ri) => (
          <circle
            key={`pulse-${ri}`}
            cx={CX}
            cy={CY}
