...
export default function CharacterWizard({ onComplete, onCancel }: CharacterWizardProps) {
  ...
  const handleCreate = useCallback(() => {
    ...
    const character: PlayerCharacter = {
      ...
      subrace: state.subrace?.index ?? null,
      subraceName: state.subrace?.name ?? null,
      class: state.class.index,
      className: state.class.name,
      subclass: state.subclass?.index ?? null,
      subclassName: state.subclass?.name ?? null,
      level: state.level,
      ...
      spellcastingAbility: state.class.spellcasting?.spellcasting_ability.name ?? null,
