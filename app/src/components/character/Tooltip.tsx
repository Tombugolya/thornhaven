    ...
    <span ref={containerRef} className="relative inline-flex items-center">
      ...
      {visible && (
        <div
          ref={tooltipRef}
          role="tooltip"
          className="absolute z-50 bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 rounded-lg text-xs text-parchment whitespace-normal min-w-48 max-w-72 text-center pointer-events-none normal-case tracking-normal font-normal"
          style={{
