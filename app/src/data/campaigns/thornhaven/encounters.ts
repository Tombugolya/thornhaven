...
export const encounters = [
  {
    ...
    enemies: [
      ...
      },
      {
        ...
        maxHp: 32,
        ac: 11,
        notes: 'Whispers "SHUT UP" very loudly',
      },
    ],
    allies: [
      {
        ...
        maxHp: 30,
        ac: 16,
        notes: "Annoyed more than alarmed",
      },
    ],
  ...
  },
  {
    ...
    difficulty: "Medium",
    description:
      "Three thugs and the Undertow Lieutenant guard the Saltworks. One thug is mid-sandwich.",
    enemies: [
      {
        id: "thug-3",
        name: "Thug (sandwich)",
        ...
        maxHp: 32,
        ac: 11,
        notes: "Mid-sandwich. Fights one-handed Round 1 (disadvantage).",
      },
      ...
      { id: "thug-5", name: "Thug 3", npcId: "thug", hp: 32, maxHp: 32, ac: 11, notes: "" },
      {
        ...
        maxHp: 33,
        ac: 13,
        notes: "The only competent one. True believer. See spell tactics.",
      },
    ],
    allies: [
      {
        ...
        maxHp: 30,
        ac: 16,
        notes: "Focused, professional. Targets thugs.",
      },
    ],
    ...
    enemies: [
      {
        ...
        maxHp: 65,
        ac: 15,
        notes: "AC 17 behind altar (half cover). Parry: +2 AC reaction.",
      },
      {
        id: "thug-6",
        name: "Reluctant Thug",
        ...
        maxHp: 32,
        ac: 11,
        notes: "Will sit down if addressed with any Persuasion check",
      },
      { id: "thug-7", name: "Thug", npcId: "thug", hp: 32, maxHp: 32, ac: 11, notes: "" },
      {
        ...
        ac: 16,
        notes:
          "Surrenders at 5 HP. Instant surrender if Maren talks (DC 13 Persuasion, ADV with Maren).",
      },
    ],
    allies: [
      {
        ...
        maxHp: 30,
        ac: 16,
        notes: "Does NOT attack Round 1. Sees Edric. Processing.",
      },
    ],
    terrain:
      "Waist-deep water = difficult terrain (half the room). Black stone altar provides half cover (+2 AC, +2 DEX saves).",
    notes: [
...
export const initiativeTemplate: { round: number; entries: unknown[] } = {
  round: 1,
  entries: [],
}
