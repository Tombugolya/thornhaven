export const battleMaps = {
  "night-encounter": {
    ...
    tokens: {
      ...
      "maren": { x: 380, y: 440, label: "Maren", initials: "MA", color: "#3498db", ally: true, autoReveal: true },
      "player": { x: 400, y: 480, label: "You", initials: "PC", color: "#c9a227", ally: true, autoReveal: true },
    },
  },
  ...
  "saltworks-rescue": {
    ...
    features: [
      ...
      // Meeting table
      { type: "furniture", x: 240, y: 180, w: 220, h: 100, label: "Meeting Table", color: "#2a1f15" },
      // Chairs around table
    ...
    tokens: {
      ...
      "lt-1": { x: 150, y: 200, label: "Lieutenant", initials: "LT", color: "#c0392b", ally: false },
      "maren": { x: 340, y: 110, label: "Maren", initials: "MA", color: "#3498db", ally: true, autoReveal: true },
      "player": { x: 360, y: 110, label: "You", initials: "PC", color: "#c9a227", ally: true, autoReveal: true },
    },
  },
  ...
  "altar-chamber": {
    ...
    tokens: {
      ...
      "player": { x: 420, y: 600, label: "You", initials: "PC", color: "#c9a227", ally: true, autoReveal: true },
    },
  },
}
